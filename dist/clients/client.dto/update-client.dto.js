...
__decorate([
    (0, class_validator_1.Matches)(/[!@#$%^&*(),.?":{}|<>]/, { message: "não pode haver caracteres especiais na propriedade $property" }),
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    (0, swagger_1.ApiProperty)({ description: "client phone number" }),
    __metadata("design:type", String)
